...
def log_results_no_label(args, train_loss, loss_pixel, loss_geometry, segmentation_accuracy, dice_score):
    wandb.log({
        'train loss': train_loss,
...
def log_results(args, train_loss, loss_pixel, loss_geometry, label_accuracy, label_accuracy2, segmentation_accuracy, predict_as_label, dice_score):
    wandb.log({
        'train loss': train_loss,
        'pixel loss': loss_pixel,
        'geometry loss': loss_geometry,
